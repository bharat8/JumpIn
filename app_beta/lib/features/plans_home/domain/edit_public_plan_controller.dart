...
class EditPublicPlanController extends GetxController {
  String _planTitle;
  String _location;
  String _category;
  ...
  Future<void> deletePublicPlanImageFromFirebaseStorage(
    ...
    if (imageFileUrl != null) {
      ...
      await photoRef.delete().then((_) {
        deletePublicPlanPhotoFromFirebaseFirestore(imageFileUrl);
      }).catchError((e) => print(e));
    }
  }

  Future deletePublicPlanPhotoFromFirebaseFirestore(imageFileUrl) async {
  ...
  void uploadPublicPlanPhotoToFirestore(downloadUrl) {
    listOfPlanPhotos.add(downloadUrl as String);
  }

  Future<void> uploadPublicPlanImage(File fileName) async {
    ...
    try {
      ...
      await uploadPublicPlanPhotoToFirestore(downloadUrl);
    } on FirebaseException catch (e) {
      print("failed");
    }
  }

  Future<void> pickImageForPublicPlan() async {
    ...
    if (pickedFile.path != null) {
      ...
      await uploadPublicPlanImage(fileName);
    }
  }
