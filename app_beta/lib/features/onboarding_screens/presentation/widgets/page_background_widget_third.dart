...
class PageBackgroundWidgetThird {
          ...
          child: LayoutBuilder(builder: (context, size) {
            return Stack(
              children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text("Shashank Arora",
                                    ...
                                    style: TextStyle(
                                        fontSize: size.maxHeight * 0.035,
                                        color: Colors.black.withOpacity(0.9),
                                        fontWeight: FontWeight.w500)),
                                Padding(
                                  padding: EdgeInsets.only(
                                      top: size.maxHeight * 0.04),
                                  child: ListTile(
                                    leading: Container(
                                      width: SizeConfig.blockSizeHorizontal * 6,
                                      height:
                                      ...
                                      child: Image.asset(
                                          "assets/images/SideNav/link.png"),
                                    ),
                                    ...
                                    title: Text(
                                      ...
                                      style: TextStyle(
                                        fontSize:
                                            SizeConfig.blockSizeVertical * 2.55,
                                      ),
                                    ),
                                  ),
                                ),
                                ...
                                ListTile(
                                  leading: Container(
                                    ...
                                    child: Image.asset(
                                        "assets/images/SideNav/connection.png"),
                                  ),
                                  title: Text(
                                    'My Connections (14)',
                                    style: TextStyle(
                                ...
                                ListTile(
                                  leading: Container(
                                    ...
                                    height: SizeConfig.blockSizeHorizontal * 6,
                                    child: Image.asset(
                                        "assets/images/SideNav/plan.png"),
                                  ),
                                ...
                                ListTile(
                                  leading: Container(
                                    ...
                                    height: SizeConfig.blockSizeHorizontal * 6,
                                    child: Image.asset(
                                        "assets/images/SideNav/request.png"),
                                  ),
                                  // leading: Icon(
                                ...
                                ListTile(
                                  leading: Container(
                                    ...
                                    height: SizeConfig.blockSizeHorizontal * 6,
                                    child: Image.asset(
                                        "assets/images/SideNav/plan-invite.png"),
                                  ),
                                ...
                                ListTile(
                                    leading: Container(
                                      ...
                                      height:
                                          SizeConfig.blockSizeHorizontal * 6,
                                      child: Image.asset(
                                          "assets/images/SideNav/recommend.png"),
                                    ),
                                    ...
                                    trailing:
                                        RichText(text: TextSpan(text: '2'))),
                                ListTile(
                                  leading: Container(
                                    width: SizeConfig.blockSizeHorizontal * 6,
                                    height: SizeConfig.blockSizeHorizontal * 6,
                                    child: Image.asset(
                                        "assets/images/SideNav/bookmark.png"),
                                  ),
                                    ...
                                    leading: Container(
                                      ...
                                      margin: EdgeInsets.only(
                                          left: SizeConfig.blockSizeHorizontal *
                                              0.5),
                                      child: Image.asset(
                                          "assets/images/SideNav/suggest.png"),
                                    ),
                                    title: Text(
                                      'Suggest Jumpin',
                                      style: TextStyle(
                                ...
                                ListTile(
                                  ...
                                  leading: Container(
                                    ...
                                    height: SizeConfig.blockSizeHorizontal * 6,
                                    child: Image.asset(
                                        "assets/images/SideNav/settings.png"),
                                  ),
                                  title: Text('Settings',
                                      style: TextStyle(
                                        fontSize:
                                ...
                                ListTile(
                                  leading: Container(
                                    ...
                                    child: Image.asset(
                                        "assets/images/SideNav/log-out.png"),
                                  ),
                ...
                Positioned(
                  top: size.maxHeight * 0.43,
                  left: size.maxWidth * 0.3,
                  child: Container(
                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: Image.asset("assets/images/Home/right.png"),
                          ),
                          Expanded(
                              child: Container(
                                  margin: EdgeInsets.only(
