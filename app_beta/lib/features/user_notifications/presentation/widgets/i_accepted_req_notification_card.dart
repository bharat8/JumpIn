...
class IAcceptedReqNotificationCard extends StatelessWidget {
  const IAcceptedReqNotificationCard(
                    ...
                    RichText(
                        ...
                        text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                  text:
                                      " @${user.fullname}'s connection request",
                                  style: TextStyle(
                                      color: ColorsJumpin.kSecondaryColor))
                            ])),
                    Container(
                          ...
                          children: [
                            ...
                            TextSpan(
                                ...
                                style: TextStyle(
                                    ...
                                    color: ColorsJumpin.kSecondaryColor)),
                            TextSpan(
                                text: " @${user.fullname}'s connection request",
                                style: TextStyle(
                                    color: ColorsJumpin.kSecondaryColor))
                          ])),
                ),
